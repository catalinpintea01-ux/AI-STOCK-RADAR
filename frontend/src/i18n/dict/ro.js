export default {
  demo: {
    ...
    risc: "Risc",
    cta: "Urmărește {simbol} — cont gratuit",
  ...
  desprePagina: {
    ...
    "cine": "AI Stock Radar este construit în România de o echipă mică, dedicată unui singur lucru: educație financiară clară, fără jargon și fără promisiuni goale. Datele complete de identificare ale operatorului se găsesc în Termeni și condiții.",
  ...
  auth: {
    ...
    panelLoginSub: "Scorurile s-au recalculat de când ai plecat.",
    registerCuSimbol: "Urmărește {simbol} — gratuit",
    registerFaraSimbol: "Creează-ți contul gratuit",
    trust1: "Fără card",
    trust2: "3 acțiuni urmărite gratuit",
    trust3: "Instrument educațional",
  ...
  landing: {
    ...
    sub: "Trend, momentum, fundamente și risc — explicate pe înțelesul tău. Vezi un scor real chiar acum, fără cont.",
    ...
    piloniTitlu: "Cum calculăm scorul 0–100",
    piloni: [
      { titlu: "Momentum", text: "Tendința prețului pe 1–26 de săptămâni: cât de consistent urcă sau coboară acțiunea." },
      { titlu: "Analiști", text: "Recomandările agregate ale analiștilor de pe Wall Street, transformate într-un scor net." },
      { titlu: "Fundamente", text: "Surprizele de profit din ultimele 4 trimestre plus achizițiile și vânzările insiderilor." },
      { titlu: "Risc", text: "Volatilitatea și beta — un risc ridicat trage scorul compozit în jos, nu în sus." },
    ],
    ponderiNota: "Ponderile afișate sunt cele de azi — se ajustează automat, în limite fixe, pe baza evaluărilor zilnice.",
    invataTitlu: "Radarul se verifică singur — și învață",
    invataText: "În fiecare zi comparăm verdictele date acum 5 zile de tranzacționare cu evoluția reală a prețurilor. Pilonii care au anticipat corect primesc treptat mai multă greutate în scor, cei care au greșit — mai puțină, cu cel mult 1 punct pe zi și limite stricte de siguranță.",
    invataStat: "Ultimele 30 de zile: {procent}% dintre verdicte s-au potrivit cu evoluția prețului ({n} evaluări).",
    invataColectare: "Primele evaluări se colectează chiar acum — statistica va apărea aici în câteva zile.",
    invataDisclaimer: "Statistică descriptivă a istoricului, nu o garanție pentru viitor și nu un sfat de investiții.",
    appsTitlu: "Explorează radarul",
    simTitlu: "Simulatorul scorului",
    simText: "Mută cei 4 piloni și vezi pe loc scorul compozit — calculat cu ponderile reale de azi.",
    simScorLabel: "Scor compozit",
    verdictOptimist: "optimist",
    verdictNeutru: "neutru",
    verdictRezervat: "rezervat",
    zileTitlu: "Auto-evaluările, zi de zi",
    zileGol: "Primele zile de evaluări se colectează chiar acum.",
    accTitlu: "Potriviri pe tip de verdict (30 de zile)",
    accDin: "din",
